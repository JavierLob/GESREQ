<?php
	...
	$lcHacer=(isset($_GET['lcHacer']))?$_GET['lcHacer']:"";
...
?>
				...
				<div id="cuadro_grande">
					...
					<form action="../controlador/control_noticia.php" name="form1" method="post" autocomplete="off">
						...
						<table style="margin-left:30%"  width="40%">
							<tr>
								<td>
									<input type="submit" name="btnbuscar" class="btnaceptar" value="Buscar" />
								</td>
								<td>
			...
			<script type="text/javascript" src="../media/js/noticia/noticia_buscar.js"></script>
